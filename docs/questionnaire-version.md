...
- Understand whether the portfolio matches those goals

The InvestIQ platform is

- Portfolio intelligence tool
- Risk awareness tool
- Values alignment tool
  Therefore, we need less information than traditional investment onboarding.

Updated Questionnaire Structure

Batch 0 — Welcome & Introduction
Purpose
Prepare the user for the experience and increase completion rates.

Content
Let's understand your portfolio better

Short Description
Answer a few quick questions about your investment goals, risk preferences, and portfolio. We'll use your responses to provide personalized insights and help you better understand your investments.

Time Estimate
5 short steps • approximately 5–7 minutes

Reassurance Note: No advanced investing knowledge required, we'll guide you through every step.
...
Batch 2 - Investment Goals
Questions 4–6 of 3

4. What is your main reason for investing?  
   Type: Single-select
...
5. How long are you planning to keep your money invested? Type: Single-select
...
- A few times a year
- Once a year
- I haven't started contributing regularly yet

Batch 3 - Risk Profile
Questions 7–9 of 3

Score Mapping Summary (internal)
...
Answer Score
Sell everything, I don't want to lose more 1
Sell some and move to safer options 2
Do nothing and wait for it to recover 3
Buy more, it's a good opportunity 4

8. How would you describe your comfort level with investment risk?  
   Type: Single-select

Answer Score
Very low — I prefer certainty over growth 1
Low — small fluctuations are okay 2
Medium — I can handle moderate ups and downs 3
High — I'm comfortable with significant swings for higher returns 4

9. How would you feel if your portfolio's value swung up or down by 15% in a single month?  
   Type: Single-select

Answer Score
Very uncomfortable — that level of change would stress me out 1
Somewhat uncomfortable — I'd rather have steadier returns 2
Neutral — I understand it's part of investing 3
Comfortable — short-term swings don't bother me 4

10. When it comes to returns and risk, what matters most to you?

Answer Score
I want to protect my money, even if it grows slowly 1
I'm okay with some ups and downs for moderate growth 2
...
Search Input
[ 🔍 Search for a stock, ETF, or mutual fund... ]

As the user types, matching results appear:

● Apple Inc. AAPL Stock
● Applied Materials AMAT Stock
● AppFolio Inc. APPF Stock

Once an asset is selected, a row is added:
Asset Name Type Quantity Market Value (USD) Remove
Apple Inc. (AAPL) Stock [ ] [ $ ] 🗑

Buttons
[ Add Another Investment ]
[ View My Insights → ] (enabled once at least one investment is added)

diversificattion
risk assessment
risk ttolerance
sector exposure
porttfolio ESG score
