        ...
        <div className="policy-card">
          ...
          <div className="policy-hero">
            ...
            <p className="policy-subtitle">
              These terms explain the conditions for using InvestIQ and the
          ...
          <div className="policy-notice">
            ...
            <div>
              ...
              <p>
                InvestIQ is currently a Minimum Viable Product (MVP). These
                terms may be updated as the platform evolves and additional
